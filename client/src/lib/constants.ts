...
export const services = [
  ...
  },
  {
    ...
    expectationsList: [
      ...
      "Premium makeup products suited to your skin type",
    ...
    packages: [
      ...
      },
      {
        ...
        features: [
          ...
          "Premium foundation and concealer",
      ...
      },
      {
        ...
        features: [
          ...
          "Luxury product line",
          "Full face application with contouring",
  ...
  },
  {
    ...
    expectationsList: [
      ...
      "Professional nail preparation and shaping",
      "Cuticle treatment and hand moisturizing",
      "Premium polish or gel application",
  ...
  },
  {
    ...
    expectationsList: [
      ...
      "Skin preparation for optimal dye absorption",
      "100% natural henna paste application",
      "Intricate detailing based on your chosen design",
    ...
    packages: [
      ...
      },
      {
        ...
        features: [
          ...
          "Premium henna with deeper staining properties",
